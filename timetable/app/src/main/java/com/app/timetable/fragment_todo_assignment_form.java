    ...
    public void onStart() {
        ...
        if(bundle != null){
            ...
            if (func.trim().equals("edit_assignment")){
                ...
                Log.e("time_show_time_start", String.valueOf(time_start));
                Log.e("time_show_time_end", String.valueOf(time_end));
                Log.e("time_show_time_left", String.valueOf(time_left));
